...
test_seq={'uav0000003_00000_s','uav0000072_06672_s','uav0000076_00241_s','uav0000107_01763_s','uav0000126_07915_s',...
    ...
    'uav0000169_00000_s','uav0000170_00000_s','uav0000171_00000_s','uav0000172_00000_s','uav0000173_00781_s','uav00pi00174_00000_s',...
...
for i=13:length(test_seq)
    ts = test_seq(i);
   % ts={'uav0000238_01280_s'};

    conf = genConfig('otb',ts{1});

    net=fullfile('../models/mdnet_otb_drone20.mat');
    % data=conf.gt;
    % save('gt.mat','data');
